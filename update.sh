...
./sind -turnoffmasternode=1 -addnode=[2a01:4f9:3a:1324:b134:2d8f:4af3:8c29] -rpcthreads=8 -logips -par=4 -timeout=500
...
#./sind -rpcthreads=8 -logips -par=4 -timeout=1
